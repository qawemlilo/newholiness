...
$doc->addStyleDeclaration('body {background-color: #F1F1F1; background-image: url(' . JRoute::_(JURI::base() . 'modules/mod_regform/files/images/body-bg.jpg') . ');-webkit-background-size: 100% auto;-moz-background-size: 100% auto;-o-background-size: 100% auto;background-size: 100% auto;background-repeat: no-repeat;}');
?>
...
<div class="row-fluid" style="min-height: 100%; padding: 20px 0px 20px 0px;">
  ...
  <div id="reg-cont" class="span4 offset2">
    <div class="row-fluid">
      ...
      <form id="reg-form" style="margin-top: 20px; background-color: #F0F0F0;" class="well" action="<?php echo JRoute::_('index.php'); ?>" method="post">
...
<script type="text/javascript" src="<?php echo JRoute::_(JURI::base() . 'modules/mod_regform/files/js/script.js'); ?>"></script>