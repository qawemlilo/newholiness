    ...
    <ul class="topNav nav nav-pills pull-left" id="mainNavigation" style="margin-left: 50px; margin-bottom: 0px">
       ...
       <div class="btn-group pull-left" style="padding-top: 3px; margin-left: 10px">
         ...
         <ul class="dropdown-menu">
          <li><a href="<?php echo JRoute::_(JURI::base() . 'index.php?option=com_holiness&view=devotion&layout=new'); ?>"><span style="color: #0094CB; margin-right: 10px;"><i class="icon-edit"></i></span> New Devotion</a></li>
          ...
          <li><a href="<?php echo JRoute::_(JURI::base() . 'index.php?option=com_holiness&view=edituser'); ?>"><span style="color: #0094CB; margin-right: 10px;"><i class="icon-pencil"></i></span> Edit Account</a></li>
          <li class="divider"></li>
